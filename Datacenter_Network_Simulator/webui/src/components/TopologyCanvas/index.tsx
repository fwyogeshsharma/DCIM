  ...
  return devices.map(d => {
    ...
    return {
      ...
      data: {
        ...
        // Static SNMP facts; the tooltip joins them against the polled
        // /snmp/status endpoint list. undefined (old payload) is meaningful:
        // snmpView then falls back to PASSIVE_DEVICE_TYPES.
