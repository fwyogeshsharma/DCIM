...
const OP_TONE: Record<OpTone, { fg: string; bg: string; border: string }> = {
  ok:      { fg: 'var(--green)', bg: 'rgba(95, 179, 126,0.10)',  border: 'rgba(95, 179, 126,0.45)' },
  danger:  { fg: 'var(--red)',   bg: 'rgba(217, 93, 82,0.10)',  border: 'rgba(217, 93, 82,0.45)' },
  warn:    { fg: '#cbb04a',      bg: 'rgba(203, 176, 74,0.10)', border: 'rgba(203, 176, 74,0.45)' },
          ...
          <div style={{ display: 'flex', gap: 4, marginBottom: 5 }}>
            ...
            <button onClick={addSub} disabled={!!busy || !dest.trim()}
              ...
              style={{ flexShrink: 0, fontSize: 9, fontWeight: 600,
                ...
                border: '1px solid rgba(95, 179, 126,0.45)', color: 'var(--green)',
                background: 'rgba(95, 179, 126,0.10)',
            ...
            : log.map(e => (
              <div key={e.Id} style={{ fontSize: 9, fontFamily: 'Consolas, monospace',
                ...
                <span style={{ color: e.Severity === 'Critical' ? 'var(--red)'
                  : e.Severity === 'Warning' ? '#cbb04a' : 'var(--green)' }}>{e.Severity}</span>{' '}
      ...
      <div style={{ flex: 1, minHeight: 0, overflow: 'hidden', padding: '12px 10px 0',
        ...
        {running && (
          <div className="group-box" style={{ flex: 1, minHeight: 0, display: 'flex', flexDirection: 'column' }}>
            ...
            <StatRow label="Endpoints:" value={status?.active_devices ?? 0} labelColor="#9a86b8" valueColor="#9a86b8" />
