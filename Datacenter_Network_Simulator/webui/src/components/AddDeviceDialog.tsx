...
const MODELS: Record<string, string[]> = {
  ...
  'server:Hewlett Packard Enterprise': ['HPE ProLiant DL360 Gen10','HPE ProLiant DL380 Gen10','HPE ProLiant DL380 Gen11','HPE ProLiant DL560 Gen10'],
  'server:Dell Technologies':    ['Dell PowerEdge R640','Dell PowerEdge R740','Dell PowerEdge R750','Dell PowerEdge R940','Dell PowerEdge R7525'],
  'server:Lenovo':               ['Lenovo ThinkSystem SR630 V2','Lenovo ThinkSystem SR650 V2','Lenovo ThinkSystem SR860 V2'],
  'server:Supermicro':           ['Supermicro SYS-120U-TNR','Supermicro SYS-220U-TNR','Supermicro AS-4124GS-TNR'],
