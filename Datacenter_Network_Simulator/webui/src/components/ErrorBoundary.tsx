      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            cursor: 'pointer', borderRadius: 6, border: '1px solid #e0a33c',
            background: '#e0a33c', color: '#17130a',
          }}
        >
          Reload
        </button>
