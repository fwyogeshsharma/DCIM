...
export default function FloorPlanPage() {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, display: 'flex', flexDirection: 'column', background: 'var(--bg-viewport)' }}>
      <div style={{
        height: 36, flexShrink: 0, display: 'flex', alignItems: 'center', gap: 12,
        padding: '0 12px', background: 'linear-gradient(180deg,var(--chrome-a),var(--chrome-b))',
      ...
      <iframe
        title="Floor Plan"
        src={src}
        style={{ flex: 1, width: '100%', border: 'none', background: 'var(--bg-viewport)' }}
      />
