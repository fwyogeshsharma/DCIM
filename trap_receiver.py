...
Usage:
    python trap_receiver.py                  # binds 0.0.0.0:162  (needs admin)
    python trap_receiver.py --port 1620      # non-privileged port
    python trap_receiver.py --host 127.0.0.1 --port 1620
"""
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            "examples:\n"
            "  python trap_receiver.py                   # port 162 (needs admin)\n"
            "  python trap_receiver.py --port 1620       # non-privileged\n"
            "  python trap_receiver.py --host 127.0.0.1 --port 1620\n\n"
