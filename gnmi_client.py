...
# Capabilities
python gnmi_client.py capabilities

# Get all devices (all loaded targets)
python gnmi_client.py get

# Get a specific device
python gnmi_client.py get --target 10.1.0.1 --path /interfaces
python gnmi_client.py get --target 10.1.0.1 --path /interfaces/interface[name=eth0]
python gnmi_client.py get --target 10.1.0.1 --path /system --path /lldp

# Subscribe ONCE
python gnmi_client.py subscribe --mode once --target 10.1.0.1

# Subscribe STREAM (every 5 s)
python gnmi_client.py subscribe --mode stream --target 10.1.0.1 --path /interfaces --interval 5

# Subscribe POLL
python gnmi_client.py subscribe --mode poll --target 10.1.0.1 --count 3 --poll-interval 2

# Set (accepted but discarded by the simulator)
python gnmi_client.py set --target 10.1.0.1 --path /system/config/hostname --value '"new-hostname"'
...
# Capabilities
python gnmi_client.py --host 10.1.0.1 --port 57400 capabilities

# Get all data from the device
python gnmi_client.py --host 10.1.0.1 --port 57400 get

# Get specific paths
python gnmi_client.py --host 10.1.0.1 --port 57400 get --path /interfaces
python gnmi_client.py --host 10.1.0.1 --port 57400 get --path /interfaces/interface[name=eth0]
python gnmi_client.py --host 10.1.0.1 --port 57400 get --path /system --path /lldp

# Subscribe ONCE
python gnmi_client.py --host 10.1.0.1 --port 57400 subscribe --mode once

# Subscribe STREAM (every 5 s)
python gnmi_client.py --host 10.1.0.1 --port 57400 subscribe --mode stream --path /interfaces --interval 5

# Subscribe POLL
python gnmi_client.py --host 10.1.0.1 --port 57400 subscribe --mode poll --count 3 --poll-interval 2

# Set
python gnmi_client.py --host 10.1.0.1 --port 57400 set --path /system/config/hostname --value '"new-hostname"'
"""
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        description="gNMI test client for the SNMP Network Simulator",
