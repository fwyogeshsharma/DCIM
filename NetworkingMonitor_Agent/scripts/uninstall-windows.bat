@echo off
REM Network Monitor Agent - Windows Uninstaller
...
set INSTALL_DIR=C:\Program Files\NetworkMonitorAgent
...
echo.
set /p REMOVE_DATA="Remove configuration and database files? (y/n): "
if /i "%REMOVE_DATA%"=="y" (
    echo Removing all files...
    rmdir /S /Q "%INSTALL_DIR%"
) else (
    echo Removing binary only (keeping config and data)...
    del /Q "%BINARY%"
)
