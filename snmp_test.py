...
--------------
  ...
  python snmp_test.py 10.0.0.1

  # Test multiple devices
  python snmp_test.py 10.0.0.1 10.0.0.2 10.0.0.3

  # Custom port / community / timeout
  python snmp_test.py 10.0.0.1 --port 1161 --community public --timeout 3

  # Also walk the interface table
  python snmp_test.py 10.0.0.1 --interfaces

  # Also walk LLDP neighbours
  python snmp_test.py 10.0.0.1 --lldp

  # Full test (system + interfaces + LLDP)
  python snmp_test.py 10.0.0.1 --full

  # Quiet — only print failures
  python snmp_test.py 10.0.0.1 10.0.0.2 --quiet
"""
